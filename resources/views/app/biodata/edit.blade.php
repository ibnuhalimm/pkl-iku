    ...
    <x-card.card-default>
        <x-card.header>
            ...
            <x-card.title class="w-full">
                {{ __('Edit Biodata') . ' - ' . $biodata->id_card_number }}
            </x-card.title>
        </x-card.header>
        <x-card.body>
            ...
            <div class="px-6 pb-6">
               ...
               <x-alert-simple color="red" id="__alertError" class="alert hidden"></x-alert-simple>
                ...
                <form action="{{ route('biodata.update') }}" method="post" id="__formCreateBiodata">
                    @csrf
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-6 gap-4 sm:gap-x-8">
                            <div class="sm:col-span-2 lg:col-span-6">
                                <div class="sm:w-1/2 lg:w-1/3 sm:pr-6">
                                    <x-form-label for="__photoCreateBiodata" isRequired="false">
                                        {{ __('Foto') }}
                                    </x-form-label>
                                    <x-form.input-file name="photo" id="__photoCreateBiodata" accept="image/*" />
                                    <div class="mt-1 text-xs">
                                        <a href="{{ $biodata->photo_url }}" target="_blank" class="text-blue-500 no-underline hover:underline">
                                            Lihat Foto
                                        </a>
                                    </div>
                                </div>
                            ...
                            <div class="lg:col-span-2">
                                ...
                                <x-input-text type="text" name="id_card_number" id="__id_card_numberCreateBiodata" value="{{ $biodata->id_card_number }}" />
                            </div>
                            <div class="lg:col-span-4">
                                <div class="lg:w-1/2 lg:pr-5">
                                    ...
                                    <x-input-text type="text" name="name" id="__nameCreateBiodata" value="{{ $biodata->name }}" />
                                </div>
                            </div>
                            <div class="lg:col-span-2">
                                ...
                                <x-input-text type="text" name="birth_place" id="__birth_placeCreateBiodata" value="{{ $biodata->birth_place }}" />
                            </div>
                            <div class="lg:col-span-2">
                                <x-form-label for="__birth_dateCreateBiodata" isRequired="true">
                                    {{ __('Tanggal Lahir') }}
                                </x-form-label>
                                <x-input-text type="text" name="birth_date" id="__birth_dateCreateBiodata" value="{{ date('d-m-Y', strtotime($biodata->birth_date)) }}" />
                            </div>
                            <div class="lg:col-span-2">
                                ...
                                <div>
                                    <x-form.select name="gender" id="__genderCreateBiodata" width="100%">
                                        <option value="L" @if ($biodata->gender == 'L') selected @endif>
                                            Laki-laki
                                        </option>
                                        <option value="P" @if ($biodata->gender != 'L') selected @endif>
                                            Perempuan
                                        </option>
                                    </x-form.select>
                                </div>
                            ...
                            <div class="lg:col-span-2">
                                ...
                                <div>
                                    <x-form.select name="religion_id" id="__religion_idCreateBiodata" class="select-religion" width="100%">
                                        <option value="{{ $biodata->religion_id }}" selected>
                                            {{ $biodata->religion->name }}
                                        </option>
                            ...
                            <div class="lg:col-span-2">
                                ...
                                <div>
                                    <x-form.select name="blood_type" id="__blood_typeCreateBiodata" width="100%">
                                        <option value="" @if (!in_array($biodata->blood_type, [ 'A', 'B', 'AB', 'O' ])) selected @endif>- Tidak Tahu -</option>
                                        <option value="A" @if ($biodata->blood_type == 'A') selected @endif>A</option>
                                        <option value="B" @if ($biodata->blood_type == 'B') selected @endif>B</option>
                                        <option value="AB" @if ($biodata->blood_type == 'AB') selected @endif>AB</option>
                                        <option value="O" @if ($biodata->blood_type == 'O') selected @endif>O</option>
                                    </x-form.select>
                                </div>
                            </div>
                            <div class="lg:col-span-2">
                                ...
                                <div>
                                    <x-form.select name="marital_status" id="__marital_statusCreateBiodata" width="100%">
                                        <option value="0" @if (empty($biodata->marital_status)) selected @endif>
                                            Belum Menikah
                                        </option>
                                        <option value="1" @if ($biodata->marital_status == 1) selected @endif>
                                            Sudah Menikah
                                        </option>
                                    </x-form.select>
                                </div>
                    ...
                    <div class="mb-10">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-6 gap-4 sm:gap-x-8">
                            <div class="lg:col-span-2">
                                ...
                                <x-input-text type="email" name="email" id="__emailCreateBiodata" value="{{ $biodata->email }}" />
                            </div>
                            <div class="lg:col-span-2">
                                <x-form-label for="__phoneCreateBiodata" isRequired="true">
                                    {{ __('No HP/Telepon') }}
                                </x-form-label>
                                <x-input-text type="text" name="phone" id="__phoneCreateBiodata" value="{{ $biodata->phone }}" />
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mb-10">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-6 gap-4 sm:gap-x-8">
                            <div class="sm:col-span-2 lg:col-span-2">
                                ...
                                <x-form.textarea name="address" id="__addressCreateBiodata" class="resize-none" rows="3">{{ $biodata->address }}</x-form.textarea>
                            </div>
                            <div class="lg:col-span-2">
                                ...
                                <div>
                                    <x-form.select name="province_id" id="__province_idCreateBiodata" width="100%">
                                        <option value="{{ $biodata->province_id }}" selected>
                            ...
                            <div class="lg:col-span-2">
                                ...
                                <div>
                                    <x-form.select name="city_id" id="__city_idCreateBiodata" width="100%">
                                        <option value="{{ $biodata->city_id }}" selected>
                                            {{ $biodata->city->name }}
                                        </option>
                                    </x-form.select>
                                </div>
                            ...
                            <div class="lg:col-span-2">
                                ...
                                <div>
                                    <x-form.select name="district_id" id="__district_idCreateBiodata" width="100%">
                                        <option value="{{ $biodata->district_id }}" selected>
                                            {{ $biodata->district->name }}
                                        </option>
                                    </x-form.select>
                                </div>
                            </div>
                            <div class="lg:col-span-2">
                                ...
                                <div>
                                    <x-form.select name="village_id" id="__village_idCreateBiodata" width="100%">
                                        <option value="{{ $biodata->village_id }}" selected>
                                            {{ $biodata->village->name }}
                                        </option>
                                    </x-form.select>
                                </div>
                            </div>
                    ...
                    <div class="mb-10">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-6 gap-4 sm:gap-x-8">
                            <div class="lg:col-span-2">
                                ...
                                <x-input-text type="text" name="father_name" id="__father_nameCreateBiodata" value="{{ $biodata->parent->father_name }}" />
                            </div>
                            <div class="lg:col-span-2">
                                ...
                                <div>
                                    <x-form.select name="father_religion_id" id="__father_religion_idCreateBiodata" class="select-religion" width="100%">
                                        {{-- <option value=""></option> --}}
                                        @foreach ($religions as $religion)
                                            <option value="{{ $religion->id }}" @if ($religion->id == $biodata->parent->father_religion_id) selected @endif>
                                                {{ $religion->name }}
                                            </option>
                                        @endforeach
                                    </x-form.select>
                                ...
                                <div>
                                    <x-form.select name="father_profession_id" id="__father_profession_idCreateBiodata" class="select-profession" width="100%">
                                        ...
                                        @foreach ($professions as $profession)
                                            <option value="{{ $profession->id }}" @if ($profession->id == $biodata->parent->father_profession_id) selected @endif>
                                                {{ $profession->name }}
                                            </option>
                                        @endforeach
                                    </x-form.select>
                                ...
                                <div>
                                    <x-form.select name="father_education_id" id="__father_education_idCreateBiodata" class="select-education" width="100%">
                                        ...
                                        @foreach ($educations as $education)
                                            <option value="{{ $education->id }}" @if ($education->id == $biodata->parent->father_education_id) selected @endif>
                                                {{ $education->name }}
                                            </option>
                                        @endforeach
                                    </x-form.select>
                            ...
                            <div class="lg:col-span-2">
                                ...
                                <div>
                                    <x-form.select name="father_is_life" id="__father_is_lifeCreateBiodata" class="select-is-life" width="100%">
                                        {{-- <option value=""></option> --}}
                                        <option value="1" @if ($biodata->parent->father_is_life == 1) selected @endif>Masih Hidup</option>
                                        <option value="0" @if ($biodata->parent->father_is_life == 0) selected @endif>Sudah Meninggal</option>
                                    </x-form.select>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="mb-10">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-6 gap-4 sm:gap-x-8">
                            <div class="lg:col-span-2">
                                ...
                                <x-input-text type="text" name="mother_name" id="__mother_nameCreateBiodata" value="{{ $biodata->parent->mother_name }}" />
                            </div>
                            <div class="lg:col-span-2">
                                ...
                                <div>
                                    <x-form.select name="mother_religion_id" id="__mother_religion_idCreateBiodata" class="select-religion" width="100%">
                                        {{-- <option value=""></option> --}}
                                        @foreach ($religions as $religion)
                                            <option value="{{ $religion->id }}" @if ($religion->id == $biodata->parent->mother_religion_id) selected @endif>
                                                {{ $religion->name }}
                                            </option>
                                        @endforeach
                                    </x-form.select>
                            ...
                            <div class="lg:col-span-2">
                                ...
                                <div>
                                    <x-form.select name="mother_profession_id" id="__mother_profession_idCreateBiodata" class="select-profession" width="100%">
                                        {{-- <option value=""></option> --}}
                                        @foreach ($professions as $profession)
                                            <option value="{{ $profession->id }}" @if ($profession->id == $biodata->parent->mother_profession_id) selected @endif>
                                                {{ $profession->name }}
                                            </option>
                                        @endforeach
                                    </x-form.select>
                            ...
                            <div class="lg:col-span-2">
                                ...
                                <div>
                                    <x-form.select name="mother_education_id" id="__mother_education_idCreateBiodata" class="select-education" width="100%">
                                        {{-- <option value=""></option> --}}
                                        @foreach ($educations as $education)
                                            <option value="{{ $education->id }}" @if ($education->id == $biodata->parent->mother_education_id) selected @endif>
                                                {{ $education->name }}
                                            </option>
                                        @endforeach
                                    </x-form.select>
                            ...
                            <div class="lg:col-span-2">
                                ...
                                <div>
                                    <x-form.select name="mother_is_life" id="__mother_is_lifeCreateBiodata" class="select-is-life" width="100%">
                                        {{-- <option value=""></option> --}}
                                        <option value="1" @if ($biodata->parent->mother_is_life == 1) selected @endif>
                                            Masih Hidup
                                        </option>
                                        <option value="0" @if ($biodata->parent->mother_is_life == 0) selected @endif>
                                            Sudah Meninggal
                                        </option>
                                    </x-form.select>
                                </div>
