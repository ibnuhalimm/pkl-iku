        ...
        <x-card.body>
            ...
            <div class="px-6 pb-6">
               ...
               <x-alert-simple color="red" id="__alertError" class="alert hidden"></x-alert-simple>
                ...
                <form action="{{ route('mahasiswa.store') }}" method="post" id="__formCreateStudent">
                    @csrf
                    ...
                    <div class="mb-10">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-6 gap-4 sm:gap-x-8 mb-5">
                            <div class="sm:col-span-2 lg:col-span-3">
                                <x-form-label for="__biodata_idCreateStudent" isRequired="true">
                                    {{ __('Biodata') }}
                                </x-form-label>
                                <div>
                                    <x-form.select name="biodata_id" id="__biodata_idCreateStudent" style="width: 100%"></x-form.select>
                                </div>
                            </div>
                        </div>
                            ...
                            <table class="w-full">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="py-2">:</td>
                                        <td class="py-2">
                                            <strong id="__nameBiodata"></strong>
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td class="py-2">:</td>
                                        <td class="py-2">
                                            <strong id="__genderBiodata"></strong>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td class="py-2">:</td>
                                        <td class="py-2">
                                            <strong id="__addressBiodata"></strong>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                    ...
                    <div class="mb-10">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-6 gap-4 sm:gap-x-8">
                            <div class="lg:col-span-2">
                                <x-form-label for="__degreeCreateStudent" isRequired="true">
                                    {{ __('Jenjang') }}
                                </x-form-label>
                                <div>
                                    <x-form.select name="degree" id="__degreeCreateStudent" style="width: 100%">
                                        <option value=""></option>
                            ...
                            <div class="lg:col-span-2">
                                <x-form-label for="__study_program_idCreateStudent" isRequired="true">
                                    {{ __('Program Studi') }}
                                </x-form-label>
                                <div>
                                    <x-form.select name="study_program_id" id="__study_program_idCreateStudent" style="width: 100%">
                                        <option value=""></option>
                            ...
                            <div class="lg:col-span-2">
                                <x-form-label for="__id_numberCreateStudent" isRequired="true">
                                    {{ __('NIM') }}
                                </x-form-label>
                                <x-input-text type="text" name="id_number" id="__id_numberCreateStudent" />
                            </div>
                            <div class="lg:col-span-2">
                                <x-form-label for="__statusCreateStudent" isRequired="true">
                                    {{ __('Status') }}
                                </x-form-label>
                                <div>
                                    <x-form.select name="status" id="__statusCreateStudent" style="width: 100%">
                                        <option value=""></option>
                            ...
                            <div class="lg:col-span-2">
                                <x-form-label for="__month_entryCreateStudent" isRequired="true">
                                    {{ __('Bulan/Tahun Masuk') }}
                                </x-form-label>
                                <div class="grid grid-cols-2 gap-x-4">
                                    <div>
                                        <x-form.select name="month_entry" id="__month_entryCreateStudent" style="width: 100%">
                                            <option value=""></option>
                                            @for ($i = 1; $i <= 12; $i++)
                                                <option value="{{ $i }}">
                                    ...
                                    <div>
                                        <x-input-text type="number" name="year_entry" id="__year_entryCreateStudent" value="{{ date('Y') }}" />
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="text-center">
                        <x-button type="button" color="gray" id="__btnCancelCreateStudent">
                            {{ __('Batal') }}
                        </x-button>
                        <x-button type="submit" color="primary" id="__btnSubmitCreateStudent">
                            {{ __('Simpan Data') }}
                        </x-button>
                    </div>
                </form>
...
@push('bottom_js')
    ...
    <script>
        ...
        $('#__biodata_idCreateStudent').select2({
        ...
        $('#__study_program_idCreateStudent').select2({
            placeholder: '- Pilih Program Studi -',
            width: 'resolve'
        });


        $('#__degreeCreateStudent').select2({
            placeholder: '- Pilih Jenjang -',
            width: 'resolve'
        });


        $('#__statusCreateStudent').select2({
            placeholder: '- Pilih Status -',
            width: 'resolve'
        });


        $('#__month_entryCreateStudent').select2({
            placeholder: '- Pilih Bulan -',
            width: 'resolve'
        });


        $('#__biodata_idCreateStudent').on('change', function() {
        ...
        $('#__btnCancelCreateStudent').on('click', function() {
        ...
        $('#__formCreateStudent').on('submit', function(event) {
            ...
            $('#__btnCancelCreateStudent').attr('disabled', true);
            $('#__btnSubmitCreateStudent').attr('disabled', true).html('Menyimpan...');
            ...
            axios.post(storeUrl, formData)
                ...
                .catch(({response}) => {
                    ...
                    $('html, body').animate({ scrollTop: 0 }, 'slow');
                    $('#__btnCancelCreateStudent').attr('disabled', false);
                    $('#__btnSubmitCreateStudent').attr('disabled', false).html('Simpan Data');
                });
